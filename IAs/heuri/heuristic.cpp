...
const int parity(int** board, const int& color)
{
    ...
    if(player > opponent)       return (100 * player) / (player + opponent);
    else if(opponent > player)  return -(100 * opponent) / (player + opponent);
    return 0;
}

const int front_parity(int** board, const int& color)
{
    int player(0), opponent(0);
...
const int mobility(int** board, const int& color)
{
...
const int corners(int** board, const int& color)
{
    int player(0), opponent(0);
...
const int corner_closeness(int** board, const int& color)
{
    int player(0), opponent(0);
...
const int borders(int** board, const int& color)
{
    int player(0), opponent(0);
...
const int heuristic(int** board, const int& color)
{
